...
export const verifyContract = async (
  ...
  try {
    ...
    const msDelay = 3000;
    const times = 4;
    // Write a temporal file to host complex parameters for hardhat-etherscan https://github.com/nomiclabs/buidler/tree/development/packages/buidler-etherscan#complex-arguments
